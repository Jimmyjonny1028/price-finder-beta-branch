// server.js (FINAL - With Caching and All Previous Features)
...
// --- FEATURE 2: CACHING ---
// Create a simple in-memory cache to store recent search results.
const searchCache = new Map();
// Cache results for 10 minutes (in milliseconds)
...
// =================================================================
// MAIN SEARCH ROUTE (Now with Caching Logic)
// =================================================================
...
app.get('/search', async (req, res) => {
    ...
    // --- FEATURE 2: Check the cache first ---
    ...
    try {
        ...
        console.log(`Kept ${sortedResults.length} final results after all filtering.`);

        // --- FEATURE 2: Store the new results in the cache ---
...
// ... (The rest of your API calling and helper functions remain exactly the same)
// ... (I've included them at the bottom for completeness)
app.listen(PORT, () => console.log(`Server is running! Open your browser to http://localhost:${PORT}`));

// =================================================================
// ALL HELPER & API FUNCTIONS (No changes needed below this line)
// =================================================================
